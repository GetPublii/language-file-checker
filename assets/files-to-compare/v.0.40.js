window.originalV040 = {
    ...
    "core": {
        ...
        "server": {
            ...
            "tokenOrServerAddressInvalid": "Provided token or server address is invalid.",
    ...
    "settings": {
        ...
        "howYtNoCookiesWorks": "When enabled, the YouTube domain for the embed URL e.g. 'www.youtube.com' will be automatically changed to 'www.youtube-nocookie.com', to prevent the embedded player from personalizing the YouTube browsing experience of the visitors, and also ensures that no information is used to customize advertising shown to the visitor outside of your site. Read more about <a href=\"https://support.google.com/youtube/answer/171780?hl=en#zippy=%2Cturn-on-privacy-enhanced-mode\">enabling privacy-enhanced mode</a>.",
        "howVimeoNoTrackWorks": "When enabled, the additional dnt=1 parameter will be added to the Vimeo embed URL (player.vimeo.com/video) to prevent the embedded player from tracking any session data, including all cookies and analytics Read more about <a href=\"https://vimeo.zendesk.com/hc/en-us/articles/360001494447-Player-parameters-overview\">Vimeo player parameters</a>.",
        ...
        "tagPrefixInfo": "Prefixes entered here will be added before the tag slug in the URL e.g. <strong>https://example.com/TAG_PREFIX/tag-slug</strong>.<br>This prefix is also used to generate the tags list page (if supported in your theme) e.g. <strong>https://example.com/TAG_PREFIX/index.html</strong>.",
        ...
        "whatsApp": "WhatsApp",
        "youMustReviewGdprSettings": "Make sure to check and review your Privacy Settings, especially the Cookie Banner settings due to some significant changes in Publii v.0.40. <a href=\"https://getpublii.com/docs/gdpr-breaking-changes\" target=\"_blank\">Read more</a>",
    ...
    "sync": {
        ...
        "branchExampleGitLabeNote": "Examples: <strong>docs</strong>, <strong>main</strong> or <strong>master</strong>.",
        ...
        "usernameOrganization": "Username / Organization",
        ...
        "websiteSynchronization": "Website synchronization",
    ...
    "tools": {
        "css": {
            ...
            "normal": "Normal",
            "putCustomCSSAMPComment": "Put your custom CSS code here (it will be used only in AMP mode)",
    ...
    "ui": {
        ...
        "posts": "Posts",
        "preview": "Preview",
        "previewFrontPageOnly": "Preview front page only",
